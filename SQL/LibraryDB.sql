...
SELECT UPPER(LastName) as LastUpper,
        ...
        DATEDIFF(DAY, JoinedDate, GETDATE()) as DaysAMember
FROM dbo.Member;


SELECT a.Title, b.Name
FROM dbo.Book a JOIN dbo.Category b
ON a.CategoryId = b.CategoryId
WHERE a.CategoryId = 1;

SELECT a.Title, CONCAT(c.FirstName)
FROM dbo.Book a JOIN dbo.BookAuthor b 
ON a.BookId = b.BookId
JOIN dbo.Author c ON b.AuthorId = c.AuthorId
...
FROM dbo.Author a CROSS JOIN dbo.Category c;
...
SELECT DISTINCT(a.Title), a.TotalCopies
FROM dbo.Book a

SELECT DISTINCT(a.Title), a.TotalCopies, COUNT(*) AS HigherThan
FROM dbo.Book a
JOIN dbo.Book b
ON a.TotalCopies > b.TotalCopies
GROUP BY a.Title, a.TotalCopies
